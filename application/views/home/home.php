...
<div class="cmlunbo">
    <div class="lunbo_img">
        <div style="display:block"><img src="/static/tmp/banner1.jpg" /></div>
        <div><img src="/static/tmp/banner2.jpg" /></div>
        <div><img src="/static/tmp/banner3.jpg" /></div>
        <div><img src="/static/tmp/banner4.jpg" /></div>
    </div>
        ...
        <div class="active clearfix">        	
            ...
            <div class="active_block clearfix activelr">
            	<div class="acitve_relative">
                	<img src="/static/tmp/active2.png" width="325px;"/>
                    <div class="active_info">
                ...
                <div style=" margin-top:2px;" class="acitve_relative">
                	<img src="/static/tmp/active3.png" width="325px;"/>
                    <div class="active_info">
                        <div class="active_title">Binggo科学家来了</div>
                        <div class="active_desc">
                            <span class="active_tag">分享</span>
                            10月31日 14：00-16：00
                        </div>
                    </div>
                </div>
            ...
            <div class="active_block acitve_relative">
            	<div><img src="/static/tmp/active4.png" width="325px;"/></div>
               	<div class="active_info">
