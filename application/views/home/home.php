...
<div class="cmlunbo">
    <div class="lunbo_img">
        <?php if(isset($carousel[0]['path'])) :?>
        <div style="display:block">
            <img src="<?php if(isset($carousel[0]['path']))echo $carousel[0]['path'];?>" />
        </div>
        <?php endif;?>
        <?php if(isset($carousel[1]['path'])) :?>
        <div>
            <img src="<?php if(isset($carousel[1]['path']))echo $carousel[1]['path'];?>" />
        </div>
        <?php endif;?>
        <?php if(isset($carousel[2]['path'])) :?>
        <div>
            <img src="<?php if(isset($carousel[2]['path']))echo $carousel[2]['path'];?>" />
        </div>
        <?php endif;?>
        <?php if(isset($carousel[3]['path'])) :?>
        <div>
            <img src="<?php if(isset($carousel[3]['path']))echo $carousel[3]['path'];?>" />
        </div>
        <?php endif;?>
    </div>
